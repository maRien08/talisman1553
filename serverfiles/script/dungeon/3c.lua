...
function CDungeon_3C:OnDungeonBegin(dungeon)
    ...
    -- 生成双方大本营和炮台
    self.Protector_Faction1 = CreateNpcInDungeon(self.ObjectId, 4806, DUNGEON_FACTION1, 617, 118, 4, self.AvgLevel, 1);
    self.Protector_Faction2 = CreateNpcInDungeon(self.ObjectId, 4806, DUNGEON_FACTION2, 929, 127, 12, self.AvgLevel, 1);

    --生成双方温泉
    local npc1 = CreateNpcInDungeon(self.ObjectId, 4809, DUNGEON_FACTION1, 598, 131, 4, self.AvgLevel, 10);
    AddEffectEx( npc1, 2208, 0,  0, 0, 0);
    local npc2 = CreateNpcInDungeon(self.ObjectId, 4809, DUNGEON_FACTION2, 947, 104, 12, self.AvgLevel, 10);
    AddEffectEx( npc2, 2208, 0,  0, 0, 0);
    
    --生成商店
    self.ShopNpc_Faction1 = CreateNpcInDungeon(self.ObjectId, 4883, DUNGEON_FACTION1, 602, 110, 4, self.AvgLevel, 10);
    self.ShopNpc_Faction2 = CreateNpcInDungeon(self.ObjectId, 4883, DUNGEON_FACTION2, 954, 132, 12, self.AvgLevel, 10);
    ...
    local defendRate3 = 3;
    -- 生成正方炮台
    CreateNpcInDungeon(self.ObjectId, 4801, DUNGEON_FACTION1, 693, 129, 8, self.AvgLevel, defendRate1);  -- 中路1（上）
    CreateNpcInDungeon(self.ObjectId, 4801, DUNGEON_FACTION1, 695, 107, 0, self.AvgLevel, defendRate1);  -- 中路1（下）
    CreateNpcInDungeon(self.ObjectId, 4801, DUNGEON_FACTION1, 648, 126, 8, self.AvgLevel, defendRate2);  -- 中路2（上）
    CreateNpcInDungeon(self.ObjectId, 4801, DUNGEON_FACTION1, 648, 108, 0, self.AvgLevel, defendRate2);  -- 中路2（下）
    CreateNpcInDungeon(self.ObjectId, 4800, DUNGEON_FACTION1, 683, 129, 8, self.AvgLevel, defendRate1);  -- 中路1（上）（减速）
    CreateNpcInDungeon(self.ObjectId, 4800, DUNGEON_FACTION1, 685, 107, 0, self.AvgLevel, defendRate1);  -- 中路1（下）（减速）
    CreateNpcInDungeon(self.ObjectId, 4800, DUNGEON_FACTION1, 638, 126, 8, self.AvgLevel, defendRate2);  -- 中路2（上）（减速）
    CreateNpcInDungeon(self.ObjectId, 4800, DUNGEON_FACTION1, 638, 108, 0, self.AvgLevel, defendRate2);  -- 中路2（下）（减速）

    CreateNpcInDungeon(self.ObjectId, 4801, DUNGEON_FACTION1, 695, 210, 8, self.AvgLevel, defendRate1);  -- 上路1（上）
    CreateNpcInDungeon(self.ObjectId, 4801, DUNGEON_FACTION1, 695, 192, 0, self.AvgLevel, defendRate1);  -- 上路1（下）
    CreateNpcInDungeon(self.ObjectId, 4801, DUNGEON_FACTION1, 632, 189, 8, self.AvgLevel, defendRate2);  -- 上路2（上）
    CreateNpcInDungeon(self.ObjectId, 4801, DUNGEON_FACTION1, 639, 176, 0, self.AvgLevel, defendRate2);  -- 上路2（下）
    CreateNpcInDungeon(self.ObjectId, 4800, DUNGEON_FACTION1, 685, 210, 8, self.AvgLevel, defendRate1);  -- 上路1（上）（减速）
    CreateNpcInDungeon(self.ObjectId, 4800, DUNGEON_FACTION1, 685, 192, 0, self.AvgLevel, defendRate1);  -- 上路1（下）（减速）
    CreateNpcInDungeon(self.ObjectId, 4800, DUNGEON_FACTION1, 623, 184, 8, self.AvgLevel, defendRate2);  -- 上路2（上）（减速）
    CreateNpcInDungeon(self.ObjectId, 4800, DUNGEON_FACTION1, 629, 170, 0, self.AvgLevel, defendRate2);  -- 上路2（下）（减速）

    CreateNpcInDungeon(self.ObjectId, 4801, DUNGEON_FACTION1, 695, 55, 8, self.AvgLevel, defendRate1);  -- 下路1（上）
    CreateNpcInDungeon(self.ObjectId, 4801, DUNGEON_FACTION1, 695, 31, 0, self.AvgLevel, defendRate1);  -- 下路1（下）
    CreateNpcInDungeon(self.ObjectId, 4801, DUNGEON_FACTION1, 637, 62, 8, self.AvgLevel, defendRate2);  -- 下路2（上）
    CreateNpcInDungeon(self.ObjectId, 4801, DUNGEON_FACTION1, 633, 48, 0, self.AvgLevel, defendRate2);  -- 下路2（下）
    CreateNpcInDungeon(self.ObjectId, 4800, DUNGEON_FACTION1, 685, 55, 8, self.AvgLevel, defendRate1);  -- 下路1（上）（减速）
    CreateNpcInDungeon(self.ObjectId, 4800, DUNGEON_FACTION1, 685, 31, 0, self.AvgLevel, defendRate1);  -- 下路1（下）（减速）
    CreateNpcInDungeon(self.ObjectId, 4800, DUNGEON_FACTION1, 627, 66, 8, self.AvgLevel, defendRate2);  -- 下路2（上）（减速）
    CreateNpcInDungeon(self.ObjectId, 4800, DUNGEON_FACTION1, 621, 52, 0, self.AvgLevel, defendRate2);  -- 下路2（下）（减速）

    CreateNpcInDungeon(self.ObjectId, 4802, DUNGEON_FACTION1, 617, 109, 8, self.AvgLevel, defendRate3);  -- 护卫1
    CreateNpcInDungeon(self.ObjectId, 4802, DUNGEON_FACTION1, 617, 129, 0, self.AvgLevel, defendRate3);  -- 护卫2
    CreateNpcInDungeon(self.ObjectId, 4802, DUNGEON_FACTION1, 624, 150, 0, self.AvgLevel, defendRate3);  -- 护卫3
    CreateNpcInDungeon(self.ObjectId, 4802, DUNGEON_FACTION1, 626, 90, 0, self.AvgLevel, defendRate3);  -- 护卫4

    -- 生成反方炮台
    CreateNpcInDungeon(self.ObjectId, 4801, DUNGEON_FACTION2, 851, 136, 8, self.AvgLevel, defendRate1);  -- 中路1（上）
    CreateNpcInDungeon(self.ObjectId, 4801, DUNGEON_FACTION2, 851, 116, 0, self.AvgLevel, defendRate1);  -- 中路1（下）
    CreateNpcInDungeon(self.ObjectId, 4801, DUNGEON_FACTION2, 902, 142, 8, self.AvgLevel, defendRate2);  -- 中路2（上）
    CreateNpcInDungeon(self.ObjectId, 4801, DUNGEON_FACTION2, 902, 116, 0, self.AvgLevel, defendRate2);  -- 中路2（下）
    CreateNpcInDungeon(self.ObjectId, 4800, DUNGEON_FACTION2, 861, 138, 8, self.AvgLevel, defendRate1);  -- 中路1（上）（减速）
    CreateNpcInDungeon(self.ObjectId, 4800, DUNGEON_FACTION2, 861, 118, 0, self.AvgLevel, defendRate1);  -- 中路1（下）（减速）
    CreateNpcInDungeon(self.ObjectId, 4800, DUNGEON_FACTION2, 912, 142, 8, self.AvgLevel, defendRate2);  -- 中路2（上）（减速）
    CreateNpcInDungeon(self.ObjectId, 4800, DUNGEON_FACTION2, 912, 116, 0, self.AvgLevel, defendRate2);  -- 中路2（下）（减速）

    CreateNpcInDungeon(self.ObjectId, 4801, DUNGEON_FACTION2, 851, 218, 8, self.AvgLevel, defendRate1);  -- 上路1（上）
    CreateNpcInDungeon(self.ObjectId, 4801, DUNGEON_FACTION2, 851, 198, 0, self.AvgLevel, defendRate1);  -- 上路1（下）
    CreateNpcInDungeon(self.ObjectId, 4801, DUNGEON_FACTION2, 902, 215, 8, self.AvgLevel, defendRate2);  -- 上路2（上）
    CreateNpcInDungeon(self.ObjectId, 4801, DUNGEON_FACTION2, 902, 195, 0, self.AvgLevel, defendRate2);  -- 上路2（下）
    CreateNpcInDungeon(self.ObjectId, 4800, DUNGEON_FACTION2, 861, 218, 8, self.AvgLevel, defendRate1);  -- 上路1（上）（减速）
    CreateNpcInDungeon(self.ObjectId, 4800, DUNGEON_FACTION2, 861, 198, 0, self.AvgLevel, defendRate1);  -- 上路1（下）（减速）
    CreateNpcInDungeon(self.ObjectId, 4800, DUNGEON_FACTION2, 912, 215, 8, self.AvgLevel, defendRate2);  -- 上路2（上）（减速）
    CreateNpcInDungeon(self.ObjectId, 4800, DUNGEON_FACTION2, 912, 195, 0, self.AvgLevel, defendRate2);  -- 上路2（下）（减速）

    CreateNpcInDungeon(self.ObjectId, 4801, DUNGEON_FACTION2, 851, 55, 8, self.AvgLevel, defendRate1);  -- 下路1（上）
    CreateNpcInDungeon(self.ObjectId, 4801, DUNGEON_FACTION2, 851, 31, 0, self.AvgLevel, defendRate1);  -- 下路1（下）
    CreateNpcInDungeon(self.ObjectId, 4801, DUNGEON_FACTION2, 902, 62, 8, self.AvgLevel, defendRate2);  -- 下路2（上）
    CreateNpcInDungeon(self.ObjectId, 4801, DUNGEON_FACTION2, 902, 31, 0, self.AvgLevel, defendRate2);  -- 下路2（下）
    CreateNpcInDungeon(self.ObjectId, 4800, DUNGEON_FACTION2, 861, 55, 8, self.AvgLevel, defendRate1);  -- 下路1（上）（减速）
    CreateNpcInDungeon(self.ObjectId, 4800, DUNGEON_FACTION2, 861, 31, 0, self.AvgLevel, defendRate1);  -- 下路1（下）（减速）
    CreateNpcInDungeon(self.ObjectId, 4800, DUNGEON_FACTION2, 912, 62, 8, self.AvgLevel, defendRate2);  -- 下路2（上）（减速）
    CreateNpcInDungeon(self.ObjectId, 4800, DUNGEON_FACTION2, 912, 36, 0, self.AvgLevel, defendRate2);  -- 下路2（下）（减速）

    CreateNpcInDungeon(self.ObjectId, 4802, DUNGEON_FACTION2, 925, 117, 8, self.AvgLevel, defendRate3);  -- 护卫1
    CreateNpcInDungeon(self.ObjectId, 4802, DUNGEON_FACTION2, 925, 137, 0, self.AvgLevel, defendRate3);  -- 护卫2
    CreateNpcInDungeon(self.ObjectId, 4802, DUNGEON_FACTION2, 925, 88, 0, self.AvgLevel, defendRate3);  -- 护卫3
    CreateNpcInDungeon(self.ObjectId, 4802, DUNGEON_FACTION2, 923, 164, 0, self.AvgLevel, defendRate3);  -- 护卫4
end
    ...
    if (winner == DUNGEON_FACTION1) then -- 阵营1赢了，阵营2输了	
 		--OutputLog(" TD_Winner1 ");
            ...
            for i=0,faction1_count-1 do
                ...
                --AddUserDungeonScore (faction1_actor,DUNGEON_PVP,delta_score1);
                AddExp (faction1_actor,self.TD_Exp1);
                AddNimbus (faction1_actor,self.TD_Nimbus1);
            ...
            for i=0,faction2_count-1 do
                ...
                --AddUserDungeonScore (faction2_actor,DUNGEON_PVP,-delta_score2);
                AddExp (faction2_actor,self.TD_Exp2);
                AddNimbus (faction2_actor,self.TD_Nimbus2);
                AddMoney (faction2_actor,self.TD_Money2);
            end
            self.TD_Score1 = delta_score1;
            self.TD_Score2 = delta_score2;
            self.TD_Winner = self.TD_Team1;
            ...
            content = string.gsub(content, "$TD_Team1", self.TD_Team1);
            ...
            content = string.gsub(content, "$TD_Team2", self.TD_Team2);
...
function CDungeon_3C:SpawnMass()
    ...
    npc = CreateNpcInDungeon(self.ObjectId, SpawnNpc[idx], DUNGEON_FACTION1, SpawnNpcPos_Center1_v1.x, SpawnNpcPos_Center1_v1.y, 0, lev, ability)
    SetNpcPatrolPath(npc, PatrolPathCenter1_v1);
    npc = CreateNpcInDungeon(self.ObjectId, SpawnNpc[idx], DUNGEON_FACTION1, SpawnNpcPos_Center1_v2.x, SpawnNpcPos_Center1_v2.y, 0, lev, ability)
    SetNpcPatrolPath(npc, PatrolPathCenter1_v2);

    idx = math.random(SpawnNpcCount);
    npc = CreateNpcInDungeon(self.ObjectId, SpawnNpc[idx], DUNGEON_FACTION2, SpawnNpcPos_Center2_v1.x, SpawnNpcPos_Center2_v1.y, 0, lev, ability)
    SetNpcPatrolPath(npc, PatrolPathCenter2_v1);
    npc = CreateNpcInDungeon(self.ObjectId, SpawnNpc[idx], DUNGEON_FACTION2, SpawnNpcPos_Center2_v2.x, SpawnNpcPos_Center2_v2.y, 0, lev, ability)
    SetNpcPatrolPath(npc, PatrolPathCenter2_v2);

    -- 上边
    idx = math.random(SpawnNpcCount);
    npc = CreateNpcInDungeon(self.ObjectId, SpawnNpc[idx], DUNGEON_FACTION1, SpawnNpcPos_Top1_v1.x, SpawnNpcPos_Top1_v1.y, 0, lev, ability)
    SetNpcPatrolPath(npc, PatrolPathTop1_v1);
    npc = CreateNpcInDungeon(self.ObjectId, SpawnNpc[idx], DUNGEON_FACTION1, SpawnNpcPos_Top1_v2.x, SpawnNpcPos_Top1_v2.y, 0, lev, ability)
    SetNpcPatrolPath(npc, PatrolPathTop1_v2);

    idx = math.random(SpawnNpcCount);
    npc = CreateNpcInDungeon(self.ObjectId, SpawnNpc[idx], DUNGEON_FACTION2, SpawnNpcPos_Top2_v1.x, SpawnNpcPos_Top2_v1.y, 0, lev, ability)
    SetNpcPatrolPath(npc, PatrolPathTop2_v1);
    npc = CreateNpcInDungeon(self.ObjectId, SpawnNpc[idx], DUNGEON_FACTION2, SpawnNpcPos_Top2_v2.x, SpawnNpcPos_Top2_v2.y, 0, lev, ability)
    SetNpcPatrolPath(npc, PatrolPathTop2_v2);

    -- 下边
    idx = math.random(SpawnNpcCount);
    npc = CreateNpcInDungeon(self.ObjectId, SpawnNpc[idx], DUNGEON_FACTION1, SpawnNpcPos_Bottom1_v1.x, SpawnNpcPos_Bottom1_v1.y, 0, lev, ability)
    SetNpcPatrolPath(npc, PatrolPathBottom1_v1);
    npc = CreateNpcInDungeon(self.ObjectId, SpawnNpc[idx], DUNGEON_FACTION1, SpawnNpcPos_Bottom1_v2.x, SpawnNpcPos_Bottom1_v2.y, 0, lev, ability)
    SetNpcPatrolPath(npc, PatrolPathBottom1_v2);

    idx = math.random(SpawnNpcCount);
    npc = CreateNpcInDungeon(self.ObjectId, SpawnNpc[idx], DUNGEON_FACTION2, SpawnNpcPos_Bottom2_v1.x, SpawnNpcPos_Bottom2_v1.y, 0, lev, ability)
    SetNpcPatrolPath(npc, PatrolPathBottom2_v1);
    npc = CreateNpcInDungeon(self.ObjectId, SpawnNpc[idx], DUNGEON_FACTION2, SpawnNpcPos_Bottom2_v2.x, SpawnNpcPos_Bottom2_v2.y, 0, lev, ability)
...
function CDungeon_3C:SpawnBoss()
    ...
    if (r == 1) then
        npc = CreateNpcInDungeon(self.ObjectId, SpawnBossId[self.NextBossIndex], DUNGEON_FACTION1, SpawnNpcPos_Center1_v1.x, SpawnNpcPos_Center1_v1.y, 0, lev, ability)
        SetNpcPatrolPath(npc, PatrolPathCenter1_v1);
    elseif (r == 2) then
        npc = CreateNpcInDungeon(self.ObjectId, SpawnBossId[self.NextBossIndex], DUNGEON_FACTION1, SpawnNpcPos_Top1_v1.x, SpawnNpcPos_Top1_v1.y, 0, lev, ability)
        SetNpcPatrolPath(npc, PatrolPathTop1_v1);
    elseif (r == 3) then
        npc = CreateNpcInDungeon(self.ObjectId, SpawnBossId[self.NextBossIndex], DUNGEON_FACTION1, SpawnNpcPos_Bottom1_v1.x, SpawnNpcPos_Bottom1_v1.y, 0, lev, ability)
        SetNpcPatrolPath(npc, PatrolPathBottom1_v1);
    end
    ...
    local r = math.random(1, 3);
    if (r == 1) then
        npc = CreateNpcInDungeon(self.ObjectId, SpawnBossId[self.NextBossIndex], DUNGEON_FACTION2, SpawnNpcPos_Center2_v1.x, SpawnNpcPos_Center2_v1.y, 0, lev, ability)
        SetNpcPatrolPath(npc, PatrolPathCenter2_v1);
    elseif (r == 2) then
        npc = CreateNpcInDungeon(self.ObjectId, SpawnBossId[self.NextBossIndex], DUNGEON_FACTION2, SpawnNpcPos_Top2_v1.x, SpawnNpcPos_Top2_v1.y, 0, lev, ability)
        SetNpcPatrolPath(npc, PatrolPathTop2_v1);
    elseif (r == 3) then
        npc = CreateNpcInDungeon(self.ObjectId, SpawnBossId[self.NextBossIndex], DUNGEON_FACTION2, SpawnNpcPos_Bottom2_v1.x, SpawnNpcPos_Bottom2_v1.y, 0, lev, ability)
        SetNpcPatrolPath(npc, PatrolPathBottom2_v1);
    end
...
function CDungeon_3C:SpawnGift()
    ...
    -- 生成守护怪
    CreateNpcInDungeon(self.ObjectId, SpawnGiftProtectorNpc, DUNGEON_FACTION_NEUTRAL, x1, y1, 0, self.CurrMassLevel, 0.6 + self.CurrMassIndex * 0.03)
